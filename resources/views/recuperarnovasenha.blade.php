                    ...
                    <form method="POST" action="{{ route('recuperar-novasenha') }}" class="form w-100">
                        ...
                        <div class="row row-gap-3">
                            <div class="col-12 form-group text-light">
                                ...
                                <input type="password" name="password" class="form-control bg-dark border-dark text-light" id="password" placeholder="example@example.com.br">
                            </div>
                            <input type="hidden" name="id" value="{{$id}}" class="form-control bg-dark border-dark text-light" id="id" placeholder="example@example.com.br">
                            <div class="col-12">
