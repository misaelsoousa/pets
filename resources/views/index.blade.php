...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="img_pets/favicon.ico">
...
<body>
    ...
    <section class="position-relative">
        <img src="img_pets/banner.webp" alt="Banner Principal" class="w-100">
        ...
        <div class="position-absolute top-0 left-0 h-100 w-100">
            <div class="container h-100">
                <div class="d-flex flex-column align-items-start justify-content-center h-100 pb-4">
                    ...
                    <a href="{{route('queroadotar')}}" class="btn btn-custom d-flex align-items-center gap-3 mt-4 px-4 text">
                        Buscar um PET
            ...
            <div class="row">
                <div class="col-4">
                    <div class="d-flex align-items-center h-100 rounded overflow-hidden" style="background-color: #FFE8BA;">
                        <img src="img_pets/cartoon-dog.webp" alt="Cachorro em desenho animado" width="130">
                ...
                <div class="col-4">
                    <div class="d-flex align-items-center h-100 rounded overflow-hidden" style="background-color: #DC9AFE;">
                        <img src="img_pets/cartoon-cat.webp" alt="Gato em desenho animado" width="130">
                        <p class="m-0 p-3 h-100 d-flex align-items-center bg-white">
                ...
                <div class="col-4">
                    <div class="d-flex align-items-center h-100 rounded overflow-hidden" style="background-color: #84FBFF;">
                        <img src="img_pets/cartoon-cat-2.webp" alt="Gato em desenho animado" width="130">
                        <p class="m-0 p-3 h-100 d-flex align-items-center bg-white">
